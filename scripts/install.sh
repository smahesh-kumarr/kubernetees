...
# Step 6: Initialize the Kubernetes Cluster (Single Node)
...
# Step 8: Install Pod Network Add-on (Calico Recommended)
echo "Installing Calico network plugin..."
kubectl apply -f https://raw.githubusercontent.com/projectcalico/calico/v3.27.0/manifests/calico.yaml

# Step 9: Allow Scheduling Pods on Control Plane (for single-node setup)
